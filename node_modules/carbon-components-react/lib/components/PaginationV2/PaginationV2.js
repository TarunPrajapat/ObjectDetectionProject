...
function (_Component) {
  ...
  _createClass(PaginationV2, [{
    ...
    value: function render() {
      ...
      var classNames = (0, _classnames2.default)("".concat(prefix, "--pagination"), className);
      var backButtonClasses = (0, _classnames2.default)("".concat(prefix, "--pagination__button"), "".concat(prefix, "--pagination__button--backward"), _defineProperty({}, "".concat(prefix, "--pagination__button--no-index"), pageInputDisabled));
