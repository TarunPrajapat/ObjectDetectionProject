...
var TableHeader = function TableHeader(_ref2) {
  ...
  var className = (0, _classnames.default)(headerClassName, (_cx = {}, _defineProperty(_cx, "".concat(prefix, "--table-sort-v2"), true), _defineProperty(_cx, "".concat(prefix, "--table-sort-v2--active"), isSortHeader && sortDirection !== _sorting.sortStates.NONE), _defineProperty(_cx, "".concat(prefix, "--table-sort-v2--ascending"), isSortHeader && sortDirection === _sorting.sortStates.DESC), _cx));
