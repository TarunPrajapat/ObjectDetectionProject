...
var Checkbox = function Checkbox(_ref) {
  var className = _ref.className,
      ...
      ref = _ref.forwardRef,
      other = _objectWithoutProperties(_ref, ["className", "id", "labelText", "onChange", "indeterminate", "hideLabel", "wrapperClassName", "title", "forwardRef"]);
...
var _default = _react.default.forwardRef(function (props, ref) {
  return _react.default.createElement(Checkbox, _extends({}, props, {
    forwardRef: ref
  }));
});
