...
function (_Component) {
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      var timePickerClasses = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--time-picker"), true), _defineProperty(_classNames, "".concat(prefix, "--time-picker--light"), light), _defineProperty(_classNames, className, className), _classNames));
