  ...
  _createClass(SearchSkeleton, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          id = _this$props.id;
      var searchClasses = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--skeleton"), true), _defineProperty(_classNames, "".concat(prefix, "--search--lg"), !small), _defineProperty(_classNames, "".concat(prefix, "--search--sm"), small), _classNames));
