...
var DataTableSkeleton = function DataTableSkeleton(_ref) {
  ...
  var dataTableSkeletonClasses = (0, _classnames.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--skeleton"), true), _defineProperty(_classNames, "".concat(prefix, "--data-table-v2"), true), _defineProperty(_classNames, "".concat(prefix, "--data-table-v2--zebra"), zebra), _defineProperty(_classNames, "".concat(prefix, "--data-table-v2--compact"), compact), _classNames));
