...
function (_PureComponent) {
  ...
  function Slider() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleDrag", function () {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var inputClasses = classNames("".concat(prefix, "--slider-text-input"), _defineProperty({}, "".concat(prefix, "--text-input--light"), light));
