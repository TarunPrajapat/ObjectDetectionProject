...
function (_React$Component) {
  ...
  _createClass(DropdownV2, [{
    ...
    value: function render() {
      ...
      var className = cx("".concat(prefix, "--dropdown"), containerClassName, _defineProperty({}, "".concat(prefix, "--dropdown--light"), light));
      ...
      var Dropdown = React.createElement(Downshift, {
        id: id,
      ...
      return title || helper ? React.createElement(React.Fragment, null, title, helper, Dropdown) : Dropdown;
    }
  }]);
