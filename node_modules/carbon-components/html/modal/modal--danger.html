...
<button class="bx--btn bx--btn--danger--primary" type="button" data-modal-target="#modal-zlvbro0npjl">Show
  modal</button>

<div data-modal id="modal-zlvbro0npjl" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-zlvbro0npjl-label" aria-describedby="modal-zlvbro0npjl-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-zlvbro0npjl-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-zlvbro0npjl-heading">Modal heading</p>
