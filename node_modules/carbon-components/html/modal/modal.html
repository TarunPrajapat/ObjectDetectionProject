...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-iecsdk3xan">Show
  modal</button>

<div data-modal id="modal-iecsdk3xan" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-iecsdk3xan-label" aria-describedby="modal-iecsdk3xan-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-iecsdk3xan-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-iecsdk3xan-heading">Modal heading</p>
