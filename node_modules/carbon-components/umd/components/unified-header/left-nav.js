(function (global, factory) {
  ...
  function (_mixin) {
    ...
    function LeftNav(element, options) {
      ...
      if (process.env.NODE_ENV !== "production") {
        process.env.NODE_ENV !== "production" ? (0, _warning.default)(didWarnAboutDeprecation, 'The `LeftNav` component in `carbon-components` has been deprecated. It will be removed in the next major release.') : void 0;
    ...
    _createClass(LeftNav, [{
      ...
      value: function hookOpenActions() {
        ...
        this.manage((0, _on.default)(openBtn, 'click', function () {
          _this4.element.tabIndex = '0';

          _this4.toggleMenu();
        }));
        this.manage((0, _on.default)(openBtn, 'keydown', function (evt) {
          if (evt.which === 13) {
            _this4.element.tabIndex = '0';
        ...
        if (closeBtn) {
          this.manage((0, _on.default)(closeBtn, 'click', function () {
            _this4.element.tabIndex = '-1';

            _this4.closeMenu();
          }));
          this.manage((0, _on.default)(closeBtn, 'keydown', function (evt) {
            if (evt.which === 13) {
              _this4.element.tabIndex = '-1';
        ...
        this.manage((0, _on.default)(this.element.ownerDocument, 'keydown', function (evt) {
      ...
      value: function hookListSectionEvents() {
        ...
        var leftNavSections = this.element.querySelector(this.options.selectorLeftNavSections);
        this.manage((0, _on.default)(leftNavSections, 'click', function (evt) {
          _this5.handleSectionItemClick(evt, leftNavSections);
        }));
        this.manage((0, _on.default)(leftNavSections, 'keydown', function (evt) {
          if (evt.which === 13) {
            _this5.handleSectionItemClick(evt, leftNavSections);
      ...
      value: function hookListItemsEvents() {
        ...
        leftNavList.forEach(function (list) {
          _this6.manage((0, _on.default)(list, 'click', function (evt) {
            var leftNavItem = (0, _eventMatches.default)(evt, _this6.options.selectorLeftNavListItem);

            if (leftNavItem) {
              var childItem = (0, _eventMatches.default)(evt, _this6.options.selectorLeftNavNestedListItem);
              var hasChildren = (0, _eventMatches.default)(evt, _this6.options.selectorLeftNavListItemHasChildren);
              var flyoutItem = (0, _eventMatches.default)(evt, _this6.options.selectorLeftNavFlyoutItem);
          ...
          _this6.manage((0, _on.default)(list, 'keydown', function (evt) {
            if (evt.which === 13) {
              var leftNavItem = (0, _eventMatches.default)(evt, _this6.options.selectorLeftNavListItem);
        ...
        flyouts.forEach(function (flyout) {
          _this6.manage((0, _on.default)(flyout, 'mouseenter', function () {
          ...
          _this6.manage((0, _on.default)(flyout, 'mouseleave', function () {
      ...
      value: function handleSectionItemClick(evt, leftNavSections) {
        ...
        var leftNavSectionItem = (0, _eventMatches.default)(evt, this.options.selectorLeftNavSection);
  ...
  var _default = !_featureFlags.breakingChangesX ? LeftNav : (0, _removedComponent.default)('LeftNav');
